...
const UpdateCoffe = () => {
    ...
    const { _id,coffeeName,coffeeSupplier,coffeeCategory,coffeeChef,coffeeTaste,coffeeDetails,coffeePhoto } = coffee;
    ...
    return (
        <div className='container mx-auto p-10 h-screen'>
           ...
           <div className="w-1/2 flex flex-col p-5">
            ...
            <input defaultValue={coffeeName} name='coffeeName' type="text"  className="input input-bordered w-full mt-2" />
                <label className='input-title'>Supplier</label>
            <input name='coffeeSupplier' type="text" defaultValue={coffeeSupplier} className="input input-bordered w-full mt-2" />
                <label className='input-title'>Category</label>
            <input name='coffeeCategory' type="text" defaultValue={coffeeCategory}  className="input input-bordered w-full mt-2" />
            </div>
           <div className="w-1/2 flex flex-col p-5">
                <label className='input-title'>Chef</label>
            <input name='coffeeChef' type='text' defaultValue={coffeeChef}  className="input input-bordered w-full mt-2" />
                <label className='input-title'>Taste</label>
            <input name='coffeeTaste' type="text" defaultValue={coffeeTaste}  className="input input-bordered w-full mt-2" />
                <label className='input-title'>Details</label>
            <input name='coffeeDetails' type="text" defaultValue={coffeeDetails} className="input input-bordered w-full mt-2" />
            </div>
           </div>
           <div className='p-5'>
           <label className='input-title'>Photo URL</label>
           <input name='coffeePhoto' type="text" defaultValue={coffeePhoto} className="input input-bordered w-full  mt-2" />
           </div>
           <div className='p-5'>
           <input type="submit"  className="btn input input-bordered w-full  mt-2" value='Update Coffee Details'/>
           </div>
           </form>
           </div>
        </div>
